...
public:
	...
	void SetTimeout(INT timeout) { m_secTimeout = timeout; }	
	CString GetRecordFile() { return sName; }	
	void ClearMsgNo() { m_msgNo=0; }	
...
private:
	INT   m_secTimeout, m_secRecord, m_secPlay;
	INT   m_SensorDiff;
	uint8 m_msgNo;
