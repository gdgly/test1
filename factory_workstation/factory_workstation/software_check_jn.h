...
class software_check_jn : public CDialogEx
{
	DECLARE_DYNAMIC(software_check_jn)

public:
	software_check_jn(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~software_check_jn();

// 对话框数据
	enum { IDD = IDD_DIALOG_check_jn };
