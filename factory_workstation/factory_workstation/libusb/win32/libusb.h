...
#endif
#pragma comment(lib,"libusb/win32/libusb.lib")
//#pragma comment(lib,"include/win32/libusb-1.0.22/MS32/dll/libusb-1.0.lib")
...
extern "C"
{
    ...
    usb_dev_handle *usb_open_by_dbcc_name(char *name);
