...
/*************************************************************************************
    ...
    Description :   This function will request BlueCore to send the current radio
                    ...
                    to be polled for the status using the hqGetRadioStatus function.
                    <p>
...
/*************************************************************************************
    ...
    Description :   Causes the device to be discoverable and connectable. This
                    ...
                    <p>
                    Firmware from 23g releases should support this command. It is
...
/*************************************************************************************
    ...
    Parameters :    handle -
                    ...
                    versionInfo -
                        ...
                        <table>
                            <tr><td> r[0] = connectionHandle
                            <tr><td> r[1] = lmpVersion, as defined by the Bluetooth spec.
                            <tr><td> r[2] = Manufacturer name.
                            <tr><td> r[3] = lmpSubversion
                        </table>
                        With BlueCore the lmpSubversion is the firmware build ID.
...
/*************************************************************************************
    ...
    Description :   This function is used to configure the BlueCore radio to transmit
                    ...
                    <p>
                    For more information see the BlueCore BCCMD commands document.
...
/*************************************************************************************
    ...
    Description :   This function gets a fault description string for the
                    ...
                    <p>
                    Fault reports sent from BlueCore can be fetched using
                    hqGetFaultReports.
