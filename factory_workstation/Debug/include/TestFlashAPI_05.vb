...
Module TestFlash
    ...
    End Function
    <DllImport("TestFlash.dll", EntryPoint:="flSetSubsysBank", _
    CharSet:=CharSet.Ansi, CallingConvention:=CallingConvention.StdCall)> _
    Function flSetSubsysBank (ByVal subSys As Byte, ByVal bank As Byte) As Integer
    End Function
    <DllImport("TestFlash.dll", EntryPoint:="flmSetSubsysBank", _
    CharSet:=CharSet.Ansi, CallingConvention:=CallingConvention.StdCall)> _
    Function flmSetSubsysBank (ByVal deviceMask As UInteger, ByVal subSys As Byte, ByVal bank As Byte) As Integer
    End Function
