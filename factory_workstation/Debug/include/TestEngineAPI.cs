...
// Generated by E:\Jenkins\workspace\BlueSuite_v3_X_Y_RCZ\common\hosttools\cda_tools_bs_3_2_1\prodtest\scripts\extract_tt_api.pl from TestEngine.h;  at 14/06/19 - 15:58:39
...
namespace TestEngineAPI
{
    public class TestEngine
    {
        ...
        [DllImport("TestEngine.dll", EntryPoint="openTestEngineDebugUnlock",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern uint openTestEngineDebugUnlock(int port, int multi, int transport, byte [] unlockKey);
        ...
        [DllImport("TestEngine.dll", EntryPoint="openTestEngineDebugTrans",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern uint openTestEngineDebugTrans(byte [] trans, int multi);
        ...
        [DllImport("TestEngine.dll", EntryPoint="openTestEngineDebugUnlockTrans",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern uint openTestEngineDebugUnlockTrans(byte [] trans, int multi, byte [] unlockKey);
        ...
        [DllImport("TestEngine.dll", EntryPoint="teGetAvailableDebugPorts",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int teGetAvailableDebugPorts(out ushort maxLen, byte [] ports, byte [] trans, out ushort count);
