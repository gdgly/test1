...
// Generated by E:\Jenkins\workspace\BlueSuite_v3_X_Y_RCZ\common\hosttools\cda_tools_bs_3_2_1\prodtest\scripts\extract_tt_api.pl from TestFlash.h; TestPS.h;  at 14/06/19 - 15:52:09
...
namespace TestFlashAPI
{
    public class TestFlash
    {
        ...
        [DllImport("TestFlash.dll", EntryPoint="flOpenUnlock",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flOpenUnlock(int port, int xtal, int delays, int transport, byte [] unlockKey);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flmOpenUnlock",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmOpenUnlock(uint deviceMask, int xtal, int transport, byte [] unlockKey);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flOpenTrans",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flOpenTrans(byte [] trans, int xtal, int delays);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flOpenUnlockTrans",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flOpenUnlockTrans(byte [] trans, int xtal, int delays, byte [] unlockKey);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flmOpenUnlockTrans",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmOpenUnlockTrans(uint deviceMask, byte [] trans, int xtal, byte [] unlockKey);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flGetAvailablePorts",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flGetAvailablePorts(out ushort maxLen, byte [] ports, byte [] trans, out ushort count);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flmGetAvailablePorts",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmGetAvailablePorts(out ushort maxLen, byte [] ports, byte [] trans, out ushort count);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flmConvertPort",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmConvertPort(byte [] transIn, byte [] transOut, out uint device);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flSetSubsysBank",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flSetSubsysBank(byte subSys, byte bank);

        [DllImport("TestFlash.dll", EntryPoint="flmSetSubsysBank",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmSetSubsysBank(uint deviceMask, byte subSys, byte bank);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flSetSqifAccess",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flSetSqifAccess(byte [] fileName);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flmSetSqifAccess",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmSetSqifAccess(uint deviceMask, byte [] fileName);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flSetSecurityKey",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flSetSecurityKey(byte [] keyValOrFileName);
        ...
        [DllImport("TestFlash.dll", EntryPoint="flmSetSecurityKey",
                CharSet=charset, CallingConvention=calling_convention)]
        public static extern int flmSetSecurityKey(uint deviceMask, byte [] keyValOrFileName);
