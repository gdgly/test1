...
LIBG7221_DEF(Word16) mult (Word16 var1, Word16 var2)
{
    ...
    L_product = (L_product & (Word32) 0xffff8000UL) >> 15;

    if (L_product & (Word32) 0x00010000UL)
        L_product = L_product | (Word32) 0xffff0000UL;
...
LIBG7221_DEF(Word16) mult_r (Word16 var1, Word16 var2)
{
    ...
    L_product_arr &= (Word32) 0xffff8000UL;
    L_product_arr >>= 15;       /* shift */

    if (L_product_arr & (Word32) 0x00010000UL)   /* sign extend when necessary */
    {
        L_product_arr |= (Word32) 0xffff0000UL;
    }
