             ...
             Word16 frame_error_flag)
{
    ...
    Word16  num_categorization_control_bits = NUM_CATEGORIZATION_CONTROL_BITS;
    Word16  num_categorization_control_possibilities = NUM_CATEGORIZATION_CONTROL_POSSIBILITIES;
    Word16  number_of_coefs = DCT_LENGTH;
    Word16  number_of_valid_coefs = NUMBER_OF_VALID_COEFS;
