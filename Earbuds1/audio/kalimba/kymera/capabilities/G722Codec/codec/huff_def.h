...
extern Word16to8  differential_region_power_bits[MAX_NUMBER_OF_REGIONS][DIFF_REGION_POWER_LEVELS];
extern UWord16 differential_region_power_codes[MAX_NUMBER_OF_REGIONS][DIFF_REGION_POWER_LEVELS];
extern Word16to8  differential_region_power_decoder_tree[MAX_NUMBER_OF_REGIONS][DIFF_REGION_POWER_LEVELS-1][2];
extern Word16  mlt_quant_centroid[NUM_CATEGORIES][MAX_NUM_BINS];
extern Word16to8  expected_bits_table[NUM_CATEGORIES];
extern Word16to8  mlt_sqvh_bitcount_category_0[196];
extern UWord16 mlt_sqvh_code_category_0[196];
extern Word16to8  mlt_sqvh_bitcount_category_1[100];
extern UWord16 mlt_sqvh_code_category_1[100];
extern Word16to8  mlt_sqvh_bitcount_category_2[49];
extern UWord16 mlt_sqvh_code_category_2[49];
extern Word16to8  mlt_sqvh_bitcount_category_3[625];
extern UWord16 mlt_sqvh_code_category_3[625];
extern Word16to8  mlt_sqvh_bitcount_category_4[256];
extern UWord16 mlt_sqvh_code_category_4[256];
extern Word16to8  mlt_sqvh_bitcount_category_5[243];
extern UWord16 mlt_sqvh_code_category_5[243];
extern Word16to8  mlt_sqvh_bitcount_category_6[32];
extern UWord16 mlt_sqvh_code_category_6[32];
extern Word16to8  *table_of_bitcount_tables[NUM_CATEGORIES-1];
