...
// The sequence of Upgrading CSRA681xx, QCC302x/3x and QCC512x devices with binary image
...
/*******************************************************************************
    ...
    Parameters :    vid -
                    ...
                    usagePage -
                        ...
                        <p>For CSRA681xx, QCC302x/3x and QCC512x devices
...
/*******************************************************************************
    ...
    Description :   Reads the image from the connected BlueCore chip and saves
                    ...
                    <p>This function is not supported for CSRA681xx, QCC302x/3x 
                    and QCC512x devices.
...
/*******************************************************************************
    ...
    Description :   Reads an image from the specified file and upgrades the 
                    ...
                    <p>This function is not supported for CSRA681xx, QCC302x/3x
                    and QCC512x devices - use hidDfuUpgradeBin instead.
...
/*******************************************************************************
    ...
    Description :   Reads a binary image from the specified file and upgrades
                    ...
                    <p>This function is supported for CSRA681xx, QCC302x/3x and
                    QCC512x devices only.
