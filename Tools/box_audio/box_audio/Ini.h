...
public:		
	...
	void __UInt64ToString(UINT64 nNumber, LPTSTR lpBuffer, int nBase) const;
	UINT64 GetUInt64(LPCTSTR lpSection, LPCTSTR lpKey, UINT nDefault, int nBase = BASE_DECIMAL) const;
